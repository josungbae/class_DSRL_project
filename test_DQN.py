...
if __name__ == "__main__":
    ...
    if envType == 0:
        Agent = __import__(f'team{team_number}.agent_chainMDP_DQN', fromlist=['agent']).agent
        Env = __import__(f'chain_mdp', fromlist=['ChainMDP']).ChainMDP
        calculate_pf = __import__(f'team{team_number}.interaction_chainMDP_DQN', fromlist=['calculate_performance']).calculate_performance
        calculate_se = __import__(f'team{team_number}.interaction_chainMDP_DQN', fromlist=['calculate_sample_efficiency']).calculate_sample_efficiency
